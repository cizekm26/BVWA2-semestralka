...
<body class="bg-white">
    ...
    <div class="px-6 py-8 sm:px-24 md:px-32 lg:px-40 xl:px-48 2xl:px-64">
        <section class="flex flex-col xl:flex-row rounded-xl">
            <form action="login.php" method="post" class="flex flex-col w-full gap-3 px-12 pt-6 pb-4 rounded-t-lg xl:w-2/3 bg-zinc-100 xl:rounded-l-xl xl:rounded-tr-none">
                ...
                <input type="text" name="login" placeholder="Zadejte přihlašovací jméno" required class="w-full px-2 pt-1 pb-2 border rounded-md border-slate-300 border-spacing-0 h-9 focus:outline-none focus:border focus:border-blue-950">
                <input type="password" name="heslo" placeholder="Zadejte heslo" required class="w-full px-2 pt-1 pb-2 border rounded-md border-slate-300 border-spacing-0 h-9 focus:outline-none focus:border focus:border-blue-950">
                <input type="submit" name="register" value="Přihlásit" class="w-40 mx-auto my-4 font-semibold text-white duration-300 ease-out rounded-md cursor-pointer bg-blue-500 h-9 hover:scale-105 hover:bg-sky-900 hover:shadow-md active:scale-95 active:bg-sky-700">
                <?php
            ...
            <div class="flex flex-col justify-between w-full h-auto text-center text-white rounded-b-lg bg-blue-500 xl:w-1/3 px-7 pt-7 xl:pb-0 pb-7 xl:rounded-r-xl xl:rounded-bl-none">
                <div class="flex flex-col">
                    ...
                    <a href="registration.php" class="mt-2 font-semibold underline duration-300 ease-out text-blue-white hover:text-slate-200 active:text-white">Zaregistrujte se!
                    </a>
                </div>
