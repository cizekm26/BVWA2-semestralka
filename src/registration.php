...
<section class="flex flex-col xl:flex-row rounded-xl">
        <div class="flex flex-col justify-between w-full h-auto text-center text-white rounded-t-lg rounded-bl-none bg-blue-600 xl:w-1/3 px-7 pt-7 xl:pb-0 pb-7 xl:rounded-l-xl xl:rounded-tr-none">
            <div class="flex flex-col">
                ...
                <a 
                    href="login.php"
                    class="mt-2 font-semibold underline duration-300 ease-out text-blue-white hover:text-slate-200 active:text-white">Přihlašte se!</a>
            </div>
        ...
        <form
            ...
            class="flex flex-col w-full gap-3 px-12 pt-6 pb-4 rounded-b-lg xl:w-2/3 bg-zinc-100 xl:rounded-r-xl xl:rounded-bl-none">
            ...
            <div class="flex flex-row gap-3">
                <select
                    name="phone_prefix"
                    required
                    class="px-2 pt-1 pb-2 border rounded-md border-slate-300 border-spacing-0 h-9 w-min focus:outline-none focus:border focus:border-blue-950">
                    <option>+420</option>
                    <option>+421</option>
                </select>
                <input
                    ...
                    required
                    class="phone-input w-full px-2 pt-1 pb-2 border rounded-md border-slate-300 border-spacing-0 h-9 focus:outline-none focus:border focus:border-blue-950">
            </div>
            ...
            <div class="flex flex-col gap-3 mt-2 lg:flex-row">
                ...
                <div class="w-full mt-1 lg:mt-0">
                    ...
                    <input 
                        ...
                        name="photo"
                        required
                        class="w-full pt-1 pb-2 pl-1 pr-2 mt-2 text-gray-400 bg-white border rounded-md input-photo border-slate-300 border-spacing-0 h-9 file:border-0 file:h-max file:cursor-pointer file:rounded-md file:bg-gray-200">
            ...
            <input
                ...
                required
                class="w-full px-2 pt-1 pb-2 border rounded-md input-login border-slate-300 border-spacing-0 h-9 focus:outline-none focus:border focus:border-blue-950">
            ...
            <div class="flex flex-col gap-3 lg:flex-row">
                <input
                    ...
                    required
                    class="w-full px-2 pt-1 pb-2 border rounded-md password-first border-slate-300 border-spacing-0 h-9 focus:outline-none focus:border focus:border-blue-950">
                <input
                    type="password"
                    name="password_second"
                    placeholder="Zadejte heslo znovu"
                    required
                    class="w-full px-2 pb-2 border rounded-md pt-1 password-second border-slate-300 border-spacing-0 h-9 focus:outline-none focus:border focus:border-blue-950">
            </div>
            ...
            <input 
                ...
                name="register"
                value="Zaregistrovat"
                class="w-1/3 mx-auto my-4 font-semibold text-white duration-300 ease-out rounded-md cursor-pointer submit-button submit-w-40 submit button register-button regiser-button bg-blue-500 h-9 hover:scale-105 hover:bg-sky-900 hover:shadow-md active:scale-95 active:bg-sky-700">
        </form>
</section>
</div>
    <!-- Javascript ... -->
